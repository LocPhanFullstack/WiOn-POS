const TDS_UI_CONFIG =
  require('./node_modules/tds-ui/tailwindcss/v2/tailwind.config.js').TDS_UI_TAILWINDCSS_CONFIG;
//màu mặc định từ tds-ui
const TDS_UI_COLOR =
  require('./node_modules/tds-ui/tailwindcss/v2/tailwind.config.js').TDS_UI_TAILWINDCSS_COLORS;
const APP_COLOR = {
  // primary:{
