...
export interface FnbShopUserGetList$Params {
...
export function fnbShopUserGetList(http: HttpClient, rootUrl: string, params?: FnbShopUserGetList$Params, context?: HttpContext): Observable<FNBAccountStrictHttpResponse<ShopUserGetListResponseDto>> {
  const rb = new RequestBuilder(rootUrl, fnbShopUserGetList.PATH, 'get');
  if (params) {
...
fnbShopUserGetList.PATH = '/api/v1/fnb-shop-users';
